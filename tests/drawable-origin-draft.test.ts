...
// Однотонный PNG 64x48 (RGBA), сгенерирован скриптом: фикстура живёт прямо в
// тесте, чтобы прогон не зависел от файлов вне репозитория.
const CAT_PNG_BASE64 =
  'iVBORw0KGgoAAAANSUhEUgAAAEAAAAAwCAYAAAChS3wfAAAAeklEQVR4nO3QMREAIBDAsJeDRCTi'
  + 'CmRkoEP2XufsdX82OkBrgA7QGqADtAboAK0BOkBrgA7QGqADtAboAK0BOkBrgA7QGqADtAboAK0B'
  + 'OkBrgA7QGqADtAboAK0BOkBrgA7QGqADtAboAK0BOkBrgA7QGqADtAboAO0BxxbVpXSGxV8AAAAA'
  + 'SUVORK5CYII=';
...
async function main(): Promise<void> {
  ...
  const sprite = await runIdylliumInBrowser({
    ...
    files: {
      ...
      '/workspace/cat.png': {
        content: '',
        bytes: new Uint8Array(Buffer.from(CAT_PNG_BASE64, 'base64')),
      },
    },
  });
