...
// Черновой страж раздела: все program-примеры canvas lessons из манифеста
...
function main(): void {
  ...
  assert(examples.length > 0, 'no canvas lessons examples found in the manifest');
  ...
  console.log(`canvas lessons draft spec: ${examples.length} examples compile`);
}
