...
// Черновой страж раздела: все program-примеры console lessons из манифеста
...
function main(): void {
  ...
  assert(examples.length > 0, 'no console lessons examples found in the manifest');
  ...
  console.log(`console lessons draft spec: ${examples.length} examples compile`);
}
