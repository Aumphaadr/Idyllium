...
const LIBRARY_METHODS = {
    ...
    types: [
        { label: 'int8', kind: 'type', detail: '8-битное знаковое целое' },
        { label: 'int16', kind: 'type', detail: '16-битное знаковое целое' },
        { label: 'int32', kind: 'type', detail: '32-битное знаковое целое' },
        { label: 'int64', kind: 'type', detail: '64-битное знаковое целое' },
        { label: 'uint8', kind: 'type', detail: '8-битное беззнаковое целое' },
        { label: 'uint16', kind: 'type', detail: '16-битное беззнаковое целое' },
        { label: 'uint32', kind: 'type', detail: '32-битное беззнаковое целое' },
        { label: 'uint64', kind: 'type', detail: '64-битное беззнаковое целое' },
        { label: 'float32', kind: 'type', detail: '32-битное дробное' },
        { label: 'float64', kind: 'type', detail: '64-битное дробное' },
        { label: 'from_bin', kind: 'method', detail: '(binStr, typeName) → fixed type', insertText: '($0)' },
        { label: 'from_hex', kind: 'method', detail: '(hexStr, typeName) → fixed type', insertText: '($0)' },
    ],
    gui: [
        ...
        { label: 'RadioButton', kind: 'type', detail: 'радиокнопка' },
        ...
        { label: 'Timer', kind: 'type', detail: 'таймер' },
        { label: 'Modal', kind: 'type', detail: 'модальное окно' },
    ],
};
...
const GUI_WIDGET_MEMBERS = {
    Window: [
        ...
        { label: 'on_show', kind: 'property', detail: 'function' },
    ],
    Button: [
    ...
    LineEdit: [
        { label: 'text', kind: 'property', detail: 'string' },
        { label: 'placeholder', kind: 'property', detail: 'string' },
        { label: 'echo_mode', kind: 'property', detail: 'string ("normal"|"password"|"no_echo")' },
        { label: 'font_size', kind: 'property', detail: 'int' },
        { label: 'enabled', kind: 'property', detail: 'bool' },
    ...
    FloatSpinBox: [
        { label: 'value', kind: 'property', detail: 'float' },
        { label: 'min', kind: 'property', detail: 'float' },
        { label: 'max', kind: 'property', detail: 'float' },
        { label: 'step', kind: 'property', detail: 'float' },
        { label: 'on_change', kind: 'property', detail: 'function' },
        { label: 'x', kind: 'property', detail: 'int' },
        { label: 'y', kind: 'property', detail: 'int' },
        { label: 'width', kind: 'property', detail: 'int' },
    ...
    RadioButton: [
        { label: 'text', kind: 'property', detail: 'string' },
        { label: 'is_selected', kind: 'property', detail: 'bool' },
        { label: 'group', kind: 'property', detail: 'string' },
        { label: 'on_change', kind: 'property', detail: 'function' },
        { label: 'x', kind: 'property', detail: 'int' },
        { label: 'y', kind: 'property', detail: 'int' },
        { label: 'width', kind: 'property', detail: 'int' },
    ...
    ComboBox: [
        { label: 'selected_index', kind: 'property', detail: 'int' },
        { label: 'selected_text', kind: 'property', detail: 'string' },
        { label: 'on_change', kind: 'property', detail: 'function' },
        { label: 'add_item', kind: 'method', detail: '(text) → void', insertText: '($0)' },
        { label: 'clear_items', kind: 'method', detail: '() → void', insertText: '()' },
        { label: 'x', kind: 'property', detail: 'int' },
        { label: 'y', kind: 'property', detail: 'int' },
        { label: 'width', kind: 'property', detail: 'int' },
        { label: 'height', kind: 'property', detail: 'int' },
    ...
    Timer: [
        { label: 'interval', kind: 'property', detail: 'int' },
        { label: 'running', kind: 'property', detail: 'bool (readonly)' },
        { label: 'on_tick', kind: 'property', detail: 'function' },
        { label: 'start', kind: 'method', detail: '() → void', insertText: '()' },
        { label: 'stop', kind: 'method', detail: '() → void', insertText: '()' },
        { label: 'restart', kind: 'method', detail: '() → void', insertText: '()' },
    ],
    Modal: [
        { label: 'title', kind: 'property', detail: 'string' },
        { label: 'message', kind: 'property', detail: 'string' },
        { label: 'confirm_text', kind: 'property', detail: 'string' },
        { label: 'cancel_text', kind: 'property', detail: 'string' },
        { label: 'on_confirm', kind: 'property', detail: 'function' },
        { label: 'on_cancel', kind: 'property', detail: 'function' },
        { label: 'show_alert', kind: 'method', detail: '() → void', insertText: '()' },
        { label: 'show_confirm', kind: 'method', detail: '() → void', insertText: '()' },
        { label: 'show_input', kind: 'method', detail: '() → void', insertText: '()' },
        { label: 'get_input_value', kind: 'method', detail: '() → string', insertText: '()' },
        { label: 'close', kind: 'method', detail: '() → void', insertText: '()' },
    ],
};
function parseCode(text, cursorPos) {
    const result = {
        classes: new Map(),
        variables: new Map(),
        functions: new Set(),
...
function resolveExpressionType(expr, parsed) {
    expr = expr.trim();
    if (expr === 'this') {
    ...
    if (expr.includes('.')) {
        ...
        let currentType = resolveExpressionType(parts[0], parsed);
...
function resolveMemberType(baseType, member, parsed) {
    ...
    if (cls) {
        ...
        if (method)
            return `function:${method.returnType}`;
    }
    return null;
}
function getCompletionsForType(type, parsed) {
    if (!type)
        return [];
...
function getDefaultWidgetMembers() {
    return [
        { label: 'x', kind: 'property', detail: 'int' },
        { label: 'y', kind: 'property', detail: 'int' },
        { label: 'width', kind: 'property', detail: 'int' },
...
function getClassMembers(cls, parsed) {
    const items = [];
...
function parseCompletionContext(text, cursorPos) {
