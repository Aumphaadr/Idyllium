...
declare function strSetChar(s: string, index: number, ch: string, file: string, line: number): string;
declare function arraysEqual(a: unknown, b: unknown): boolean;
...
declare function createConsoleModule(io: ConsoleIO): {
    ...
    writeln(...args: unknown[]): Promise<void>;
...
declare function initValueDeep<T>(value: T): Promise<T>;
