...
export type Expression = IntLiteralExpr | FloatLiteralExpr | StringLiteralExpr | CharLiteralExpr | BoolLiteralExpr | ArrayLiteralExpr | IdentifierExpr | ThisExpr | BinaryExpr | UnaryMinusExpr | NotExpr | FunctionCallExpr | MethodCallExpr | PropertyAccessExpr | IndexAccessExpr | LambdaExpr | ConstructorCallExpr | ParentCallExpr;
