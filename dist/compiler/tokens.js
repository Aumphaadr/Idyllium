...
(function (TokenType) {
    ...
    TokenType[TokenType["KW_STATIC"] = 41] = "KW_STATIC";
    TokenType[TokenType["KW_PARENT"] = 42] = "KW_PARENT";
    TokenType[TokenType["KW_DIV"] = 43] = "KW_DIV";
    TokenType[TokenType["KW_MOD"] = 44] = "KW_MOD";
    TokenType[TokenType["PLUS"] = 45] = "PLUS";
    TokenType[TokenType["MINUS"] = 46] = "MINUS";
    TokenType[TokenType["STAR"] = 47] = "STAR";
    TokenType[TokenType["SLASH"] = 48] = "SLASH";
    TokenType[TokenType["ASSIGN"] = 49] = "ASSIGN";
    TokenType[TokenType["PLUS_ASSIGN"] = 50] = "PLUS_ASSIGN";
    TokenType[TokenType["MINUS_ASSIGN"] = 51] = "MINUS_ASSIGN";
    TokenType[TokenType["STAR_ASSIGN"] = 52] = "STAR_ASSIGN";
    TokenType[TokenType["SLASH_ASSIGN"] = 53] = "SLASH_ASSIGN";
    TokenType[TokenType["EQ"] = 54] = "EQ";
    TokenType[TokenType["NEQ"] = 55] = "NEQ";
    TokenType[TokenType["LT"] = 56] = "LT";
    TokenType[TokenType["GT"] = 57] = "GT";
    TokenType[TokenType["LTE"] = 58] = "LTE";
    TokenType[TokenType["GTE"] = 59] = "GTE";
    TokenType[TokenType["LPAREN"] = 60] = "LPAREN";
    TokenType[TokenType["RPAREN"] = 61] = "RPAREN";
    TokenType[TokenType["LBRACE"] = 62] = "LBRACE";
    TokenType[TokenType["RBRACE"] = 63] = "RBRACE";
    TokenType[TokenType["LBRACKET"] = 64] = "LBRACKET";
    TokenType[TokenType["RBRACKET"] = 65] = "RBRACKET";
    TokenType[TokenType["COMMA"] = 66] = "COMMA";
    TokenType[TokenType["SEMICOLON"] = 67] = "SEMICOLON";
    TokenType[TokenType["DOT"] = 68] = "DOT";
    TokenType[TokenType["COLON"] = 69] = "COLON";
    TokenType[TokenType["TILDE"] = 70] = "TILDE";
    TokenType[TokenType["IDENTIFIER"] = 71] = "IDENTIFIER";
    TokenType[TokenType["EOF"] = 72] = "EOF";
